**Краткое описание:** Учебный проект, командная разработка. **Задача:** создать интерактивного телеграм-бота, который получает от пользователя и записывает в базу данных текстовую информацию и файлы.
